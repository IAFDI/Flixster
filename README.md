...
![Video Walkthrough](http://g.recordit.co/64x5U64DKt.gif)'

GIF created with [RecordIt](http://recordit.co/).

## Notes

I had difficulty with implementing the rounded edges funcitonality and the background/poster image for the viewing details activity.
These two aspects involved utilizing Glide and intent via Parceler.
